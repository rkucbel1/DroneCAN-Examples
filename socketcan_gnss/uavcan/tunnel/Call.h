 ...
 *
 * Source file: /home/rkucbel1/socketcan_gnss/libcanard/DSDL-master/uavcan/tunnel/63.Call.uavcan
 */
...
static inline
uint32_t uavcan_tunnel_CallRequest_encode(uavcan_tunnel_CallRequest* source, void* msg_buf, bool tao_enabled);

static inline
int32_t uavcan_tunnel_CallRequest_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallRequest* dest, uint8_t** dyn_arr_buf, bool tao_enabled);

static inline
uint32_t uavcan_tunnel_CallRequest_encode_internal(uavcan_tunnel_CallRequest* source, void* msg_buf, uint32_t offset, uint8_t root_item, bool tao_enabled);

static inline
int32_t uavcan_tunnel_CallRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallRequest* dest, uint8_t** dyn_arr_buf, int32_t offset, bool tao_enabled);
...
static inline
uint32_t uavcan_tunnel_CallResponse_encode(uavcan_tunnel_CallResponse* source, void* msg_buf, bool tao_enabled);

static inline
int32_t uavcan_tunnel_CallResponse_decode(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallResponse* dest, uint8_t** dyn_arr_buf, bool tao_enabled);

static inline
uint32_t uavcan_tunnel_CallResponse_encode_internal(uavcan_tunnel_CallResponse* source, void* msg_buf, uint32_t offset, uint8_t root_item, bool tao_enabled);

static inline
int32_t uavcan_tunnel_CallResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len, uavcan_tunnel_CallResponse* dest, uint8_t** dyn_arr_buf, int32_t offset, bool tao_enabled);
  ...
  bool tao_enabled)
{
    ...
    // Compound
    offset = uavcan_tunnel_Protocol_encode_internal(&source->protocol, msg_buf, offset, 0, tao_enabled);
...
uint32_t uavcan_tunnel_CallRequest_encode(uavcan_tunnel_CallRequest* source, void* msg_buf, bool tao_enabled)
{
    ...
    offset = uavcan_tunnel_CallRequest_encode_internal(source, msg_buf, offset, 1, tao_enabled);
  ...
  bool tao_enabled)
{
    ...
    // Compound
    offset = uavcan_tunnel_Protocol_decode_internal(transfer, payload_len, &dest->protocol, dyn_arr_buf, offset, tao_enabled);
    if (offset < 0)
    {
        ret = offset;
  ...
  bool tao_enabled)
{
    ...
    ret = uavcan_tunnel_CallRequest_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao_enabled);
...
uint32_t uavcan_tunnel_CallResponse_encode(uavcan_tunnel_CallResponse* source, void* msg_buf, bool tao_enabled)
{
    ...
    offset = uavcan_tunnel_CallResponse_encode_internal(source, msg_buf, offset, 1, tao_enabled);
  ...
  bool tao_enabled)
{
    ...
    ret = uavcan_tunnel_CallResponse_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao_enabled);
